...
public:
 ...
 // ----- Custom Covoid copyName(const Name& other);py -----
  // Copy content of one Name to another
 ...
 // ----- Setters and Getters -----
 void setFirstName(const char* ); // Assign first name
 void setLastName(const char*); // Assign last name
